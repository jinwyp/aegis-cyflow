                    ...
                    <form class="form-horizontal" data-parsley-validate="" novalidate="" ms-validate="@addValidate">
                        <fieldset>
                            ...
                            <div class="form-group" ms-class="[@errorInputName.indexOf('inputUsername')>-1 && 'has-error' ]">
                                ...
                                <div class="col-sm-5 lineH34" ms-visible="@errorInputName.indexOf('inputUsername')>-1">{{@errorMessage.inputUsername}}</div>
                            </div>
                        </fieldset>
                        <fieldset>
                            <div class="form-group" ms-class="[@errorInputName.indexOf('inputUserRole')>-1 && 'has-error' ]">
                                ...
                                <div class="col-sm-5 lineH34" ms-visible="@errorInputName.indexOf('inputUserRole')>-1">{{@errorMessage.inputUserRole}}</div>
                            </div>
                        </fieldset>
                        <fieldset ms-visible="@currentUser.role === @role.traderAccountant">
                            <div class="form-group" ms-class="[!@isMYSCWValid && 'has-error']">
                                ...
                                <div class="col-sm-5 lineH34" ms-visible="!@isMYSCWValid">请选择贸易商</div>
                            </div>
                        </fieldset>
                        <fieldset ms-visible="@currentUser.role === @role.fundProviderAccountant">
                            <div class="form-group" ms-class="[!@isMYSCWValid && 'has-error']">
                                ...
                                <div class="col-sm-5 lineH34"  ms-visible="!@isMYSCWValid">请选择资金方</div>
                            </div>
                        </fieldset>
                        <fieldset>
                            <div class="form-group" ms-class="[@errorInputName.indexOf('inputCompanyName')>-1 && 'has-error' ]">
                                ...
                                <div class="col-sm-5 lineH34" ms-visible="@errorInputName.indexOf('inputCompanyName')>-1">{{@errorMessage.inputCompanyName}}</div>
                            </div>
                        </fieldset>
                        <fieldset>
                        ...
                        <fieldset>
                            <div class="form-group" ms-class="[@errorInputName.indexOf('inputMobilePhone')>-1 && 'has-error'] ">
                                ...
                                <div class="col-sm-5 lineH34" ms-visible="@errorInputName.indexOf('inputMobilePhone')>-1">{{@errorMessage.inputMobilePhone}}</div>
                            </div>
                        </fieldset>
