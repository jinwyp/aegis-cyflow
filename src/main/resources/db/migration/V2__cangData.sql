...
VALUES
	(1, 'trader', '1724', '上海瑞易供应链管理有限公司', 0, '2017-01-15 19:59:11');
...
INSERT INTO `cyflow`.`party_user` (`party_id`,`user_id`, `password`, `phone`, `email`, `name`,`username`) VALUES ('3','00000', '123456', '13800000001', 'systemAdmin@1.com', 'systemAdmin1', 'admin1');
