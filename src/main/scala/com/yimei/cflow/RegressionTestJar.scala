...
/**
  ...
  */
object RegressionTestJar extends App with ApplicationConfig
 // with CorsSupport
{
  ...
  for (i <- 1 to 1) {
    TestUtil.test("money", proxy, client, s"00$i", s"hary$i", s"fund$i", s"wangqiId$i", s"fund$i", s"wqGroup$i")
  }
